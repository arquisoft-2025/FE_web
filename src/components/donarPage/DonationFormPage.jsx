...
function DonationFormPage() {
  ...
  // ✅ FUNCIÓN HÍBRIDA: REST para crear, GraphQL para consultar
  const createDonation = async (donationData) => {
    ...
    formDataToSend.append("condition", donationData.condition);
    formDataToSend.append("city", donationData.city);
    formDataToSend.append("image", donationData.image);
    if (donationData.address) formDataToSend.append("address", donationData.address);
    if (donationData.expiration_date)
      formDataToSend.append("expiration_date", donationData.expiration_date);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ USAR ENDPOINT REST PARA CREAR DONACIÓN
